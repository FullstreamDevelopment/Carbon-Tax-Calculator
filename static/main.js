...
(function() {
	...
	// "On Visible" animations.
		...
		onvisible.add('#image07', { style: 'fade-right', speed: 1250, intensity: 8, delay: 125, replay: false });
		onvisible.add('#container02 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 3, delay: 0, replay: false });
		onvisible.add('#container03 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 3, delay: 0, replay: false });
		onvisible.add('.container.style1', { style: 'fade-in', speed: 1000, intensity: 3, delay: 0, replay: false });
		onvisible.add('#container01 > .wrapper > .inner', { style: 'fade-up', speed: 1000, intensity: 3, delay: 0, replay: false });
		onvisible.add('#container14', { style: 'fade-up', speed: 1000, intensity: 3, delay: 0, replay: false });
